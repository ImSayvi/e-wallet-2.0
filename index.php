                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="amountInput" placeholder="Wprowadź kwotę">
                        </div>

                        <div class="form-group">
                            <label for="category">Kategoria</label>
                            <select class="form-select" id="category" onchange="showInput(this)">
                        ...
                        <div class="form-group otherCategoryDiv" id="otherCategoryDiv">
                            ...
                            <input type="text" class="form-control" id="otherCategory" aria-describedby="otherCategory" placeholder="Wprowadź nazwę kategorii">
                        </div>
